...
def send_mail(**kwargs):
    ...
    # To: {},
    # Subject: {},
    # """.format(from_addr, email_address, mail_object)

    # # header  = 'From: %s,' % from_addr
    # # header += 'To: {},'.format(email_address)
    # # header += 'Subject: %s,' % mail_object
    ...
    # sender_email = "lespronosdebastien@gmail.com"
    # receiver_email = email_address
    # message = """\From: From Bastien <pronosdujour@bot.com>
    # \Subject: {}
    # {}""".format(mail_object, content.encode("utf-8"))
